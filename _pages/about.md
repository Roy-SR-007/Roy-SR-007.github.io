...
In addition to my research activities, I also currently hold the position of the Class Representative as well as the Placement Coordinator of the BCSE'22 batch. As a part of the [IEEE Student Activities Committee](https://students.ieee.org/) operating out of [Jadavpur University](http://www.jaduniv.edu.in), I have also been recently elected as the Chairperson of the [Computer Society](https://www.computer.org/) Chapter of the [IEEE JU Student Branch](https://ieee-jaduniv.in/).
